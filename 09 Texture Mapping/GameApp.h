...
public:
    struct VSConstantBuffer
    {
        ...
        DirectX::XMMATRIX texCoordTransform;
    };
...
private:
    ...
    ComPtr<ID3D11ShaderResourceView> m_pFlare;                 //旋转火焰
    ComPtr<ID3D11ShaderResourceView> m_pFlareAlpha;
    ComPtr<ID3D11ShaderResourceView> pShaderResourceViews[2] = { m_pFlareAlpha.Get(), m_pFlare.Get() };
